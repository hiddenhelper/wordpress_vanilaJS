...
jQuery( window.document ).ready(function($){
    ...
    $('.branda-social-logo-add-accounts' ).on( 'click', function() {
        ...
        if ( 0 === $( 'li', parent ).not('.hidden').length ) {
            $('.branda-social-logo-add-dialog-button', $(this).closest('.sui-accordion-item-body') ).prop( 'disabled', 'disabled' );
        }
    ...
    jQuery( selector, parent )
        .on( 'click', function() {
            ...
            if ( jQuery(this).is(':checked' ) ) {
                jQuery('input[type=checkbox]', jQuery(this).closest( '.sui-col' ) ).prop( 'checked', 'checked' );
            } else {
...
jQuery( window.document ).ready( function($) {
    function branda_copy_settings_check( dialog ) {
        ...
        if ( 1 > sections.length ) {
            $('.branda-copy-settings-copy-button', dialog ).prop( 'disabled', 'disabled' );
        } else {
