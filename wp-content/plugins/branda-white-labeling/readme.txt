...
Plugin Name: Branda – White Label WordPress, Maintenance Mode and Coming Soon Pages
Version: 3.3.1
Author: WPMU DEV
Author URI: https://premium.wpmudev.org/
Contributors: WPMUDEV
Tags: white label wordpress, coming soon page, wordpress maintenance mode, site under construction, coming soon template, customize system emails, custom login page
...
**Customize every aspect of WordPress to fit your brand with Branda, the only premium and 100% free white label plugin for WordPress. Transform your dashboard, customize system emails, quickly toggle maintenance mode and coming soon landing pages, change every aspect of your login screen, remove or replace logos, create color schemes, and much, much more.**
...
On your personal blog it is not a huge problem, but for a small business, design and development agency, or any professional site, a finished look with a complete brand package is important. That’s where Branda comes in!
...
- Header Content - Insert content into the header of every page on your website, i.e. news/notification on top of the regular website header.
- Login Screen - Customize the default login screen. Start with a pre-designed template or use the builder to redesign it from scratch.
...
Yes! Branda is 100% free and has the same features as [Branda Pro](https://premium.wpmudev.org/project/ultimate-branding/?utm_source=wordpress.org&utm_medium=readme&utm_campaign=branda-readme&utm_content=branda_pro#trial) without limitations. The only difference with the free version is the inclusion of contextual promotion of our other relevant plugins. Enjoy :)

= What about GDPR and User Privacy? =
Branda includes tools that make it easy for you to follow data protection regulations and keep your visitor’s data safe. When using features like Tracking Codes and Cookie Notice, be sure and follow privacy guidelines and update your terms of service.
...
= DATE: 17 August, 2020  - VERSION: 3.3.2 =

Fix: WP 5.5 compatibility issues

= DATE: 17 March, 2020  - VERSION: 3.3.1 =
...
= DATE: 29 October, 2019  - VERSION: 3.3 =

Add: Fully customize the admin menu based on user role
Add: Ability to redirect to external sites after log out
Add: Email subject variable now available in HTML email templates
Add: Slightly changed plugin name and added helpful contextual links on the WP plugins page
Add: Access to Branda settings granted to all admin users
...
= DATE: 16 September, 2019  - VERSION: 3.2.1 =

Fix: Non-admin user added to permissions tab in some scenarios

= DATE: 02 September, 2019  - VERSION: 3.2.0 =
...
= DATE: 10 June, 2019 - VERSION: 3.1.2 =
...
= DATE: 16 March, 2019  - VERSION: 3.1.1 =

- Fixed a problem with logo height.

= DATE: 15 March, 2019  - VERSION: 3.1.0 =
...
- Added an ability to preview saved page on module "DB Error Page".
...
= DATE: 20 February, 2019  - VERSION: 3.0.5.1 =

- Hide Admin Bar for non-logged users by default.

= DATE: 14 February, 2019  - VERSION: 3.0.5 =
...
= DATE: 13 February, 2019  - VERSION: 3.0.4 =

- Fixed a related library problem.

= DATE: 13 February, 2019  - VERSION: 3.0.3 =

- Fixed a problem with data migration in "Cookie Notice" module - the background was set as the text colour.

= DATE: 12 February, 2019  - VERSION: 3.0.2 =

- Fixed a problem with sites with non-default language - in some configuration it cause white screen on whole site.

= DATE: 12 February, 2019  - VERSION: 3.0.1 =

- Fixed a problem with too early admin object call.

= DATE: 11 February, 2019  - VERSION: 3.0.0 =
...
- Added an ability to customize size and position for background images.
- Added "Custom CSS" field to all front-end modules.
- Added an ability to choose units "px", "%", "em" and "rem" on a few settings in few modules.
- Added an ability to choose case sensitivity for user/blog signup code. Props for Ian.
...
- Added an ability to copy settings for sections: "Logo", "Background" and "Social Media".
- Added an ability to hide "Privacy Policy" link on the login screen.
...
- Added an ability to preserve plugin settings on uninstall.
- Added an ability to turn off comments.
...
- Added an ability to choose social media icons position on "Author Box" module.
- Added an ability to display more backgrounds on "Custom Login Screen" module.
- Added an ability to set the background color for the box and social media on "Admin Box" module.
- Added an ability to show colored social media icons on "Admin Box" module.
...
- Added an ability to choose post types for "Author Box".
- Added an ability to show colored social media icons on "Comming Soon Page & Maintenance" module.
...
- Added an ability to import custom admin bar menus.
...
- Added an ability to parse shortcodes in custom footer & header.
...
- Added an ability to show tips on selected admin pages (module "Admin Panel Tips").
...
- Added an ability to show "Admin Bar" for non-logged users.
...
- Fixed problem with deleting translation (Network Wide Text Change)
- Small notification text change
- Better apostrophe handling in Network wide text change
- Ability to specify text change for admin, front-end or both
- Fixed bug that removed theme options tab when in dashboard ( Dashboard widgets )
- Fixed bug caused by some servers that fail to return image sizes ( Login Image )
- Added “Admin Message”
...
- Added an ability to reorder custom menus as well as default menus ( Custom Admin Bar )
...
- Added an ability to edit Admin Bar's style ( Custom Admin Bar )
...
- Added an ability to add unlimited menus and submenus (Custom Admin Bar)
- Added an ability to order parent and child menus (Custom Admin Bar)
- Added an ability to set mailto for menu url (Custom Admin Bar)
...
- Added an ability to activate plugin on a site by site basis in a multi-site network and brand each site individually.
